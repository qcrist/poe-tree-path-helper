...
public class DatTypesV1 {
    ...
    public static class Essences implements DatType{
        @Offset(0) public ForeignRow BaseItemTypesKey; //foreignrow
        @Offset(192) public ForeignRow Display_Wand_ModsKey; //foreignrow
        @Offset(208) public ForeignRow Display_Bow_ModsKey; //foreignrow
        @Offset(224) public ForeignRow Display_Quiver_ModsKey; //foreignrow
        @Offset(240) public ForeignRow Display_Amulet_ModsKey; //foreignrow
        @Offset(256) public ForeignRow Display_Ring_ModsKey; //foreignrow
        @Offset(272) public ForeignRow Display_Belt_ModsKey; //foreignrow
        @Offset(288) public ForeignRow Display_Gloves_ModsKey; //foreignrow
        @Offset(304) public ForeignRow Display_Boots_ModsKey; //foreignrow
        @Offset(320) public ForeignRow Display_BodyArmour_ModsKey; //foreignrow
        @Offset(336) public ForeignRow Display_Helmet_ModsKey; //foreignrow
        @Offset(352) public ForeignRow Display_Shield_ModsKey; //foreignrow
        @Offset(368) public int HASH32; //i32
        @Offset(372) public List<Integer> DropLevel; //i32
        @Offset(388) public List<ForeignRow> Monster_ModsKeys; //foreignrow
        @Offset(404) public ForeignRow EssenceTypeKey; //foreignrow
        @Offset(420) public int Level; //i32
        @Offset(440) public ForeignRow Display_Weapon_ModsKey; //foreignrow
        @Offset(456) public ForeignRow Display_MeleeWeapon_ModsKey; //foreignrow
        @Offset(472) public ForeignRow Display_OneHandWeapon_ModsKey; //foreignrow
        @Offset(488) public ForeignRow Display_TwoHandWeapon_ModsKey; //foreignrow
        @Offset(504) public ForeignRow Display_TwoHandMeleeWeapon_ModsKey; //foreignrow
        @Offset(520) public ForeignRow Display_Armour_ModsKey; //foreignrow
        @Offset(536) public ForeignRow Display_RangedWeapon_ModsKey; //foreignrow
        @Offset(552) public ForeignRow Helmet_ModsKey; //foreignrow
        @Offset(568) public ForeignRow BodyArmour_ModsKey; //foreignrow
        @Offset(584) public ForeignRow Boots_ModsKey; //foreignrow
        @Offset(600) public ForeignRow Gloves_ModsKey; //foreignrow
        @Offset(616) public ForeignRow Bow_ModsKey; //foreignrow
        @Offset(632) public ForeignRow Wand_ModsKey; //foreignrow
        @Offset(648) public ForeignRow Staff_ModsKey; //foreignrow
        @Offset(664) public ForeignRow TwoHandSword_ModsKey; //foreignrow
        @Offset(680) public ForeignRow TwoHandAxe_ModsKey; //foreignrow
        @Offset(696) public ForeignRow TwoHandMace_ModsKey; //foreignrow
        @Offset(712) public ForeignRow Claw_ModsKey; //foreignrow
        @Offset(728) public ForeignRow Dagger_ModsKey; //foreignrow
        @Offset(744) public ForeignRow OneHandSword_ModsKey; //foreignrow
        @Offset(760) public ForeignRow OneHandThrustingSword_ModsKey; //foreignrow
        @Offset(776) public ForeignRow OneHandAxe_ModsKey; //foreignrow
        @Offset(792) public ForeignRow OneHandMace_ModsKey; //foreignrow
        @Offset(808) public ForeignRow Sceptre_ModsKey; //foreignrow
        @Offset(824) public ForeignRow Display_Monster_ModsKey; //foreignrow
        @Offset(840) public int ItemLevelRestriction; //i32
        @Offset(844) public ForeignRow Belt_ModsKey; //foreignrow
        @Offset(860) public ForeignRow Amulet_ModsKey; //foreignrow
        @Offset(876) public ForeignRow Ring_ModsKey; //foreignrow
        @Offset(892) public ForeignRow Display_Jewellery_ModsKey; //foreignrow
        @Offset(908) public ForeignRow Shield_ModsKey; //foreignrow
        @Offset(924) public ForeignRow Display_Items_ModsKey; //foreignrow
        @Offset(940) public boolean IsScreamingEssence; //bool
        @Offset(941) public List<ForeignRow> MemoryLines; //foreignrow
        @Offset(973) public List<Integer> Level2; //i32
    }
    ...
    public static class PantheonPanelLayout implements DatType{
        ...
        @Offset(209) public boolean IsDisabled; //bool
        @Offset(210) public List<ForeignRow> AchievementItems; //foreignrow
        @Offset(226) public int LeagueQuestFlag1; //i32
        @Offset(230) public int LeagueQuestFlag2; //i32
        @Offset(234) public int LeagueQuestFlag3; //i32
        @Offset(238) public ForeignRow DowngradeFlag1; //foreignrow
        @Offset(254) public ForeignRow DowngradeFlag2; //foreignrow
        @Offset(270) public ForeignRow DowngradeFlag3; //foreignrow
    }
    ...
    public static class DelveCraftingModifiers implements DatType{
        ...
        @Offset(119) public List<ForeignRow> SellPrice_ModsKeys; //foreignrow
        @Offset(135) public boolean CanRollWhiteSockets; //bool
        @Offset(136) public List<ForeignRow> Weight_TagsKeys; //foreignrow
        @Offset(152) public List<Integer> Weight_Values; //i32
        @Offset(168) public List<ForeignRow> DelveCraftingModifierDescriptionsKeys; //foreignrow
        @Offset(184) public List<ForeignRow> BlockedDelveCraftingModifierDescriptionsKeys; //foreignrow
    }
    ...
    public static class AlternateQualityTypes implements DatType{
        ...
        @Offset(48) public List<ForeignRow> MapStats; //foreignrow
        @Offset(68) public boolean IsCatalyst; //bool
        @Offset(69) public short HASH16; //i16
        @Offset(71) public ForeignRow CatalystMod; //foreignrow
    }
    ...
    public static class ExpeditionCurrency implements DatType{
        @Offset(0) public ForeignRow BaseItemType; //foreignrow
        @Offset(16) public int Tier; //i32
        @Offset(20) public ForeignRow NPC; //foreignrow
        @Offset(36) public ForeignRow LootSound; //foreignrow
    }
    ...
    public static class Acts implements DatType{
        @Offset(0) public String Id; //string
        @Offset(8) public int Part; //i32
        @Offset(24) public int ActNumber; //i32
        @Offset(28) public String WorldPanelImage; //string
        @Offset(36) public String WorldPanelImageEpilogue; //string
        @Offset(48) public boolean IsPostGame; //bool
    }
    ...
    public static class ArmourTypes implements DatType{
        @Offset(0) public ForeignRow BaseItemTypesKey; //foreignrow
        @Offset(16) public int ArmourMin; //i32
        @Offset(20) public int ArmourMax; //i32
        @Offset(24) public int EvasionMin; //i32
        @Offset(28) public int EvasionMax; //i32
        @Offset(32) public int EnergyShieldMin; //i32
        @Offset(36) public int EnergyShieldMax; //i32
        @Offset(40) public int IncreasedMovementSpeed; //i32
        @Offset(44) public int WardMin; //i32
        @Offset(48) public int WardMax; //i32
    }
    public static class Ascendancy implements DatType{
        ...
        @Offset(84) public String BackgroundImage; //string
    }
    ...
    public static class BaseItemTypes implements DatType{
        ...
        @Offset(312) public boolean IgnoreQuantBonus; //bool
    }
    ...
    public static class Characters implements DatType{
        ...
        @Offset(148) public String IntroSoundFile; //string
        @Offset(156) public List<ForeignRow> StartWeapons; //foreignrow
        @Offset(172) public String Gender; //string
        @Offset(180) public String TraitDescription; //string
        @Offset(272) public String PassiveTreeImage; //string
        @Offset(288) public String TencentVideo; //string
        @Offset(296) public String AttrsAsId; //string
        @Offset(304) public String LoginScreen; //string
        @Offset(312) public String PlayerCritter; //string
        @Offset(320) public String PlayerEffect; //string
        @Offset(328) public String AfterImage; //string
        @Offset(336) public ForeignRow Mirage; //foreignrow
        @Offset(352) public ForeignRow CloneImmobile; //foreignrow
        @Offset(368) public ForeignRow ReplicateClone; //foreignrow
        @Offset(384) public ForeignRow LightningClone; //foreignrow
        @Offset(408) public String SkillTreeBackground; //string
        @Offset(416) public ForeignRow Clone; //foreignrow
        @Offset(432) public ForeignRow Double; //foreignrow
        @Offset(448) public ForeignRow MirageWarrior; //foreignrow
        @Offset(464) public ForeignRow DoubleTwo; //foreignrow
        @Offset(480) public ForeignRow DarkExile; //foreignrow
        @Offset(496) public String Attr; //string
        @Offset(504) public String AttrLowercase; //string
        @Offset(512) public String Script; //string
    }
    ...
    public static class CraftingBenchOptions implements DatType{
        @Offset(0) public ForeignRow HideoutNPCsKey; //foreignrow
        ...
        @Offset(367) public boolean MapDevice; //bool
        @Offset(384) public List<ForeignRow> Tags; //foreignrow
    }
    ...
    public static class Flasks implements DatType{
        ...
        @Offset(40) public ForeignRow BuffDefinitionsKey; //foreignrow
        @Offset(56) public List<Integer> BuffStatValues; //i32
        @Offset(72) public int RecoveryTime2; //i32
        @Offset(76) public List<Integer> BuffStatValues2; //i32
    }
    ...
    public static class GemTags implements DatType{
        ...
        @Offset(64) public ForeignRow Stat4; //foreignrow
    }
    ...
    public static class GrantedEffects implements DatType{
        ...
        @Offset(33) public int Attribute; //enumrow
        @Offset(37) public List<ForeignRow> AddedActiveSkillTypes; //foreignrow
        @Offset(53) public List<ForeignRow> ExcludedActiveSkillTypes; //foreignrow
        @Offset(69) public boolean SupportsGemsOnly; //bool
        @Offset(90) public boolean CannotBeSupported; //bool
        @Offset(95) public int CastTime; //i32
        @Offset(99) public ForeignRow ActiveSkill; //foreignrow
        @Offset(115) public boolean IgnoreMinionTypes; //bool
        @Offset(117) public List<ForeignRow> AddedMinionActiveSkillTypes; //foreignrow
        @Offset(133) public ForeignRow Animation; //foreignrow
        @Offset(149) public ForeignRow MultiPartAchievement; //foreignrow
        @Offset(166) public List<ForeignRow> SupportWeaponRestrictions; //foreignrow
        @Offset(182) public long RegularVariant; //row
        @Offset(203) public ForeignRow StatSet; //foreignrow
    }
    public static class GrantedEffectsPerLevel implements DatType{
        @Offset(0) public ForeignRow GrantedEffect; //foreignrow
        @Offset(16) public int Level; //i32
        @Offset(20) public float PlayerLevelReq; //f32
        @Offset(24) public int CostMultiplier; //i32
        @Offset(28) public int StoredUses; //i32
        @Offset(32) public int Cooldown; //i32
        @Offset(36) public int CooldownBypassType; //enumrow
        @Offset(40) public int VaalSouls; //i32
        @Offset(44) public int VaalStoredUses; //i32
        @Offset(48) public int CooldownGroup; //i32
        @Offset(56) public int SoulGainPreventionDuration; //i32
        @Offset(60) public int AttackSpeedMultiplier; //i32
        @Offset(68) public List<Integer> CostAmounts; //i32
        @Offset(84) public List<ForeignRow> CostTypes; //foreignrow
        @Offset(100) public int ManaReservationFlat; //i32
        @Offset(104) public int ManaReservationPercent; //i32
        @Offset(108) public int LifeReservationFlat; //i32
        @Offset(112) public int LifeReservationPercent; //i32
        @Offset(116) public int AttackTime; //i32
    }
    public static class GrantedEffectStatSets implements DatType{
        @Offset(0) public String Id; //string
        @Offset(8) public List<ForeignRow> ImplicitStats; //foreignrow
        @Offset(24) public List<ForeignRow> ConstantStats; //foreignrow
        @Offset(40) public List<Integer> ConstantStatsValues; //i32
        @Offset(56) public float BaseEffectiveness; //f32
        @Offset(60) public float IncrementalEffectiveness; //f32
    }
    public static class GrantedEffectStatSetsPerLevel implements DatType{
        ...
        @Offset(20) public float PlayerLevelReq; //f32
        @Offset(24) public int SpellCritChance; //i32
        @Offset(28) public int AttackCritChance; //i32
        @Offset(32) public int BaseMultiplier; //i32
        @Offset(36) public int DamageEffectiveness; //i32
        @Offset(40) public List<Integer> BaseResolvedValues; //i32
        @Offset(56) public List<Integer> AdditionalStatsValues; //i32
        @Offset(72) public List<ForeignRow> GrantedEffects; //foreignrow
        @Offset(88) public List<ForeignRow> AdditionalFlags; //foreignrow
        @Offset(104) public List<ForeignRow> FloatStats; //foreignrow
        @Offset(120) public List<ForeignRow> InterpolationBases; //foreignrow
        @Offset(136) public List<ForeignRow> AdditionalStats; //foreignrow
        @Offset(152) public List<Integer> StatInterpolations; //enumrow
        @Offset(168) public List<Float> FloatStatsValues; //f32
    }
    ...
    public static class ItemClasses implements DatType{
        ...
        @Offset(131) public List<Integer> MaxInventoryDimensions; //i32
        @Offset(147) public List<Integer> Flags; //enumrow
        @Offset(163) public boolean Unmodifiable; //bool
        @Offset(164) public boolean CanBeFractured; //bool
        @Offset(165) public ForeignRow EquipAchievements; //foreignrow
        @Offset(181) public boolean UsedInMapDevice; //bool
    }
    ...
    public static class ItemVisualIdentity implements DatType{
        ...
        @Offset(226) public List<ForeignRow> Pickup_AchievementItemsKeys; //foreignrow
        @Offset(242) public List<String> SMFiles; //string
        @Offset(258) public List<ForeignRow> Identify_AchievementItemsKeys; //foreignrow
        @Offset(274) public String EPKFile; //string
        @Offset(282) public List<ForeignRow> Corrupt_AchievementItemsKeys; //foreignrow
        @Offset(298) public boolean IsAlternateArt; //bool
        @Offset(300) public ForeignRow CreateCorruptedJewelAchievementItemsKey; //foreignrow
        @Offset(316) public String AnimationLocation; //string
        @Offset(420) public boolean IsAtlasOfWorldsMapIcon; //bool
        @Offset(421) public boolean IsTier16Icon; //bool
        @Offset(463) public int Composition; //i32
    }
    ...
    public static class Maps implements DatType{
        ...
        @Offset(32) public ForeignRow Unique_WorldAreasKey; //foreignrow
        @Offset(48) public ForeignRow MapUpgrade_BaseItemTypesKey; //foreignrow
        @Offset(64) public List<ForeignRow> MonsterPacksKeys; //foreignrow
        @Offset(80) public ForeignRow AchievementItem; //foreignrow
        @Offset(96) public String Regular_GuildCharacter; //string
        @Offset(104) public String Unique_GuildCharacter; //string
        @Offset(112) public int Tier; //i32
        @Offset(116) public long Shaped_Base_MapsKey; //row
        @Offset(124) public int Shaped_AreaLevel; //i32
        @Offset(128) public long UpgradedFrom_MapsKey; //row
        @Offset(136) public long MapsKey2; //row
        @Offset(144) public long MapsKey3; //row
        @Offset(152) public int MapSeriesKey; //i32
    }
    public static class MapSeries implements DatType{
        ...
        @Offset(72) public String Purple_DDSFile; //string
    }
    ...
    public static class PassiveSkills implements DatType{
        ...
        @Offset(161) public ForeignRow GrantedEffectsPerLevel; //foreignrow
        @Offset(177) public boolean IsAnointmentOnly; //bool
        @Offset(182) public boolean IsExpansion; //bool
        @Offset(183) public boolean IsProxyPassive; //bool
        @Offset(184) public int SkillType; //enumrow
        @Offset(188) public ForeignRow MasteryGroup; //foreignrow
        @Offset(204) public ForeignRow Group; //foreignrow
        @Offset(220) public ForeignRow SoundEffect; //foreignrow
    }
    ...
    public static class SkillGems implements DatType{
        ...
        @Offset(61) public boolean IsSupport; //bool
        @Offset(67) public long AwakenedVariant; //row
        @Offset(75) public long RegularVariant; //row
        @Offset(87) public ForeignRow ItemExperienceType; //foreignrow
        @Offset(103) public List<ForeignRow> MtxSlotTypes; //foreignrow
        @Offset(119) public List<ForeignRow> GemEffects; //foreignrow
    }
    ...
    public static class WeaponTypes implements DatType{
        ...
        @Offset(20) public int Speed; //i32
        @Offset(24) public int DamageMin; //i32
        @Offset(28) public int DamageMax; //i32
        @Offset(32) public int RangeMax; //i32
    }
    ...
    public static class GemEffects implements DatType{
        ...
        @Offset(8) public String Name; //string
        @Offset(16) public ForeignRow GrantedEffect; //foreignrow
        @Offset(32) public ForeignRow GrantedEffectHardmode; //foreignrow
        @Offset(48) public ForeignRow GrantedEffect2; //foreignrow
        @Offset(64) public ForeignRow GrantedEffect2Hardmode; //foreignrow
        @Offset(80) public String SupportText; //string
        @Offset(88) public String SupportName; //string
        @Offset(96) public List<ForeignRow> GemTags; //foreignrow
        @Offset(112) public ForeignRow Consumed_ModsKey; //foreignrow
        @Offset(128) public int ItemColor; //i32
    }
